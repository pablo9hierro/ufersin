...
import { Navigate, useNavigate } from '../../lib/tenantRouter'
...
export default function Uiux2Historico() {
          ...
          <ul className="space-y-4">
            {orders.map((order) => (
              <li key={order.id} className="u2-card p-4">
                ...
                <button onClick={() => handleBuyAgain(order)} disabled={buyingAgainId === order.id} className="u2-btn-secondary w-full flex items-center justify-center gap-2 text-sm py-2 disabled:opacity-60">
