...
const AdminLayoutCliente = lazyWithReload(() => import('./pages/admin/AdminLayoutCliente'))
const AdminCrm = lazyWithReload(() => import('./pages/admin/AdminCrm'))
const AdminChat = lazyWithReload(() => import('./pages/admin/AdminChat'))
const MotoboyFila = lazyWithReload(() => import('./pages/motoboy/MotoboyFila'))
const MotoboyCorrida = lazyWithReload(() => import('./pages/motoboy/MotoboyCorrida'))
const MotoboyFinanceiro = lazyWithReload(() => import('./pages/motoboy/MotoboyFinanceiro'))
const MotoboyConta = lazyWithReload(() => import('./pages/motoboy/MotoboyConta'))

const Uiux2Landing = lazyWithReload(() => import('./uiux2/pages/Landing'))
const Uiux2Catalogo = lazyWithReload(() => import('./uiux2/pages/Catalogo'))
const Uiux2ProdutoDetalhe = lazyWithReload(() => import('./uiux2/pages/ProdutoDetalhe'))
const Uiux2ServicoDetalhe = lazyWithReload(() => import('./uiux2/pages/ServicoDetalhe'))
const Uiux3ServicoDetalhe = lazyWithReload(() => import('./uiux3/pages/ServicoDetalhe'))
const Uiux4ServicoDetalhe = lazyWithReload(() => import('./uiux4/pages/ServicoDetalhe'))
const Uiux2ServicosCatalogo = lazyWithReload(() => import('./uiux2/pages/ServicosCatalogo'))
const Uiux3ServicosCatalogo = lazyWithReload(() => import('./uiux3/pages/ServicosCatalogo'))
const Uiux4ServicosCatalogo = lazyWithReload(() => import('./uiux4/pages/ServicosCatalogo'))
const Uiux2Carrinho = lazyWithReload(() => import('./uiux2/pages/Carrinho'))
const Uiux2Checkout = lazyWithReload(() => import('./uiux2/pages/Checkout'))
const Uiux2Consultar = lazyWithReload(() => import('./uiux2/pages/Consultar'))
const EletronicaHome = lazyWithReload(() => import('./pages/eletronicos/EletronicaHome'))
const EletronicaLoja = lazyWithReload(() => import('./pages/eletronicos/EletronicaLoja'))
const EletronicaConsultar = lazyWithReload(() => import('./pages/eletronicos/EletronicaConsultar'))
const EletronicaCatalogoServico = lazyWithReload(() => import('./pages/eletronicos/EletronicaCatalogoServico'))
...
const EletronicaAdminConta = lazyWithReload(() => import('./pages/eletronicos/EletronicaAdminConta'))
const EletronicaRelatorios = lazyWithReload(() => import('./pages/eletronicos/EletronicaRelatorios'))
const EletronicaServicoDeslocamento = lazyWithReload(() => import('./pages/eletronicos/EletronicaServicoDeslocamento'))
const Uiux2RecuperarSenha = lazyWithReload(() => import('./uiux2/pages/RecuperarSenha'))
const Uiux2Favoritos = lazyWithReload(() => import('./uiux2/pages/Favoritos'))
const Uiux2Cupons = lazyWithReload(() => import('./uiux2/pages/Cupons'))
const Uiux2Historico = lazyWithReload(() => import('./uiux2/pages/Historico'))
const Uiux2Banner = lazyWithReload(() => import('./uiux2/pages/Banner'))
const Uiux2BannerCheckout = lazyWithReload(() => import('./uiux2/pages/BannerCheckout'))
const Uiux2Pagamento = lazyWithReload(() => import('./uiux2/pages/Pagamento'))

const Uiux3Landing = lazyWithReload(() => import('./uiux3/pages/Landing'))
const Uiux3Catalogo = lazyWithReload(() => import('./uiux3/pages/Catalogo'))
const Uiux3ProdutoDetalhe = lazyWithReload(() => import('./uiux3/pages/ProdutoDetalhe'))
const Uiux3Carrinho = lazyWithReload(() => import('./uiux3/pages/Carrinho'))
const Uiux3Checkout = lazyWithReload(() => import('./uiux3/pages/Checkout'))
const Uiux3Consultar = lazyWithReload(() => import('./uiux3/pages/Consultar'))
const Uiux3RecuperarSenha = lazyWithReload(() => import('./uiux3/pages/RecuperarSenha'))
const Uiux3Favoritos = lazyWithReload(() => import('./uiux3/pages/Favoritos'))
const Uiux3Cupons = lazyWithReload(() => import('./uiux3/pages/Cupons'))
const Uiux3Historico = lazyWithReload(() => import('./uiux3/pages/Historico'))
const Uiux3Banner = lazyWithReload(() => import('./uiux3/pages/Banner'))
const Uiux3BannerCheckout = lazyWithReload(() => import('./uiux3/pages/BannerCheckout'))
const Uiux3Pagamento = lazyWithReload(() => import('./uiux3/pages/Pagamento'))

const Uiux4Landing = lazyWithReload(() => import('./uiux4/pages/Landing'))
const Uiux4Catalogo = lazyWithReload(() => import('./uiux4/pages/Catalogo'))
const Uiux4ProdutoDetalhe = lazyWithReload(() => import('./uiux4/pages/ProdutoDetalhe'))
const Uiux4Carrinho = lazyWithReload(() => import('./uiux4/pages/Carrinho'))
const Uiux4Checkout = lazyWithReload(() => import('./uiux4/pages/Checkout'))
const Uiux4Consultar = lazyWithReload(() => import('./uiux4/pages/Consultar'))
const Uiux4RecuperarSenha = lazyWithReload(() => import('./uiux4/pages/RecuperarSenha'))
const Uiux4Favoritos = lazyWithReload(() => import('./uiux4/pages/Favoritos'))
const Uiux4Cupons = lazyWithReload(() => import('./uiux4/pages/Cupons'))
const Uiux4Historico = lazyWithReload(() => import('./uiux4/pages/Historico'))
const Uiux4Banner = lazyWithReload(() => import('./uiux4/pages/Banner'))
const Uiux4BannerCheckout = lazyWithReload(() => import('./uiux4/pages/BannerCheckout'))
const Uiux4Pagamento = lazyWithReload(() => import('./uiux4/pages/Pagamento'))
