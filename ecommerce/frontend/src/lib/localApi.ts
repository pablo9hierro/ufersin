...
function fakePixCode(): string {
  ...
  return `00020126580014BR.GOV.BCB.PIX0136${rand}5204000053039865802BR5913RESOLUTOO DEMO6009SAO PAULO62070503***6304ABCD`
}
...
export const localApi = {
  ...
  admin: {
    ...
    point: {
      ...
      syncStore: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      listPos: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      createPos: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      deletePos: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      listTerminals: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      syncTerminals: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      getEmployeePos: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      setEmployeePos: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      setVendedorPointTap: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      createOrder: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      getOrder: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      cancelOrder: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      getOrderCharge: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      chargeOrder: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
      cancelOrderCharge: async () => { throw new ApiError(403, 'recurso não está disponível no modo demonstração') },
    },
