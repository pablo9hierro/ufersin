...
// Banners de promoção: só Management/Premium. Essential → EssentialHeroCard.
export default function PromoCarousel() {
  ...
  return (
    <div className="px-4 sm:px-8 pt-5">
      <div
        className="relative overflow-hidden rounded-2xl aspect-[2/1] max-w-xl mx-auto"
        ...
        <div className="flex items-center justify-center gap-1.5 mt-2.5">
          {items.map((it, i) => (
            <span
              ...
              style={{ width: i === activeIndex ? 16 : 6, background: i === activeIndex ? 'var(--u4-orange)' : 'color-mix(in srgb, var(--u4-gray) 35%, transparent)' }}
            />
          ))}
        </div>
      )}
