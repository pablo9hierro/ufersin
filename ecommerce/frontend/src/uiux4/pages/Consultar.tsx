    ...
    <Shell>
      <div className="px-4 sm:px-8 pt-5 pb-16 max-w-xl mx-auto">
        ...
        <div className="flex gap-2 mb-6">
          <input className="u4-input flex-1 px-3.5 py-2.5 text-sm outline-none" value={phone} onChange={(e) => setPhone(formatPhone(e.target.value))} placeholder="(83) 99999-9999" type="tel" inputMode="numeric" />
          <button onClick={() => search(phone)} disabled={loading} className="u4-btn-primary px-5">
