    ...
    return (
      <Shell>
        <div className="px-4 sm:px-8 pt-16 flex justify-center">
          <Loader2 className="w-6 h-6 animate-spin u3-dim" aria-label="Carregando checkout" />
        </div>
      </Shell>
    )
  }
      ...
      <div className="px-4 sm:px-8 pt-5 pb-20 max-w-xl mx-auto">
        ...
        <div className="u3-panel p-4 sm:p-6 space-y-5">
          ...
          <div>
            ...
            {paymentMethod === 'dinheiro' && (
              <CashAmountInput
                ...
                trocoClassName={`text-sm font-semibold whitespace-nowrap ${cashCents / 100 < total ? 'text-amber-500' : 'u3-accent'}`}
              />
            )}
          </div>
          ...
          <div className="space-y-2 pt-1">
            <label className="flex items-start gap-2.5 cursor-pointer text-xs u3-dim">
              <input
                type="checkbox"
          ...
          <button
            ...
            className="u3-pill-primary w-full text-base py-3.5 flex items-center justify-center gap-2"
          >
