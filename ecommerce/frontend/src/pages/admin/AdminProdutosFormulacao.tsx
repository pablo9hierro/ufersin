...
export default function AdminProdutosFormulacao() {
  ...
  const saveIngredient = async () => {
    ...
    try {
      ...
      setIngredientError(e instanceof ApiError ? e.message : 'Não foi possível salvar o insumo.')
    } finally {
  ...
  const removeIngredient = (i: Ingredient) =>
    askConfirm('Remover este insumo?', async () => {
  ...
  return (
    <div>
      <div className="flex flex-wrap items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-black">ERP Formulação</h1>
      </div>

      <Card className="p-4 mb-6">
        <p className="text-sm text-son-silver-dim">
          Cadastre <span className="text-emerald-400 font-semibold">insumos</span> (farinha, açúcar, sal...) e monte a{' '}
          <span className="text-emerald-400 font-semibold">ficha técnica</span> de produtos como pão ou bolo. O estoque e o
          custo desses produtos são <span className="text-white font-semibold">calculados automaticamente</span> a partir do
          estoque dos insumos — pra aumentar o estoque do produto, aumente o estoque dos insumos.
        </p>
      </Card>
      ...
      <div className="grid grid-cols-2 gap-2 mb-6 max-w-sm">
        {(['insumos', 'produtos'] as const).map((value) => (
          ...
          >
            {value === 'insumos' ? 'Insumos' : 'Produtos formulados'}
          </button>
        ))}
      </div>
      ...
      {loading ? (
        ...
        <div>
          ...
          {ingredients.length === 0 ? (
            <p className="text-sm text-son-silver-dim">Nenhum insumo cadastrado ainda.</p>
          ) : (
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => !ingredientSaving && setIngredientForm(null)}>
          <div className="glass rounded-2xl p-6 max-w-sm w-full" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-white">{ingredientForm.id ? 'Editar insumo' : 'Novo insumo'}</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-xl border border-white/10 bg-son-surface px-3 py-3 space-y-1 text-sm">
                  ...
                  <p className="text-son-silver-dim">
                    ...
                    {preview.limitingName && <span> (insumo limitante: {preview.limitingName})</span>}
                  </p>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-son-silver-dim mt-1">Calculado automaticamente pela disponibilidade dos insumos.</p>
                  </div>
                </div>
                <div>
                  <label className="label">
