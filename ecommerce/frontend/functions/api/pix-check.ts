// Cloudflare Pages Function — porta de frontend/api/pix-check.ts. Confere o
// status de uma cobrança Pix na AbacatePay e confirma o pagamento no
// Supabase se já foi pago. Chamada tanto pelo polling do navegador
// (Pagamento.tsx) quanto pelo cron de backstop do Supabase
// (sunset_pix_backstop) — funciona igual pros dois casos.
