-- Tabela oficial de municipios do IBGE (fonte: servicodados.ibge.gov.br/
-- api/v1/localidades/municipios, baixada em 2026-09-09) -- substitui os
-- campos livres fiscal_uf/fiscal_municipio (texto digitado a mao) por
-- dropdown dependente com codigo IBGE real, que o documento fiscal exige.
...
INSERT INTO municipios_ibge (codigo_ibge, nome, uf) VALUES
...
-- fiscal_municipio/fiscal_uf (0032) continuam como texto pro payload que
-- ja vai pro Jubilados -- so adiciona o codigo oficial ao lado, exigido
-- pelo documento fiscal (nome sozinho nao serve pra isso).
ALTER TABLE subscribers
  ADD COLUMN IF NOT EXISTS fiscal_municipio_codigo_ibge TEXT REFERENCES municipios_ibge(codigo_ibge);
